...
let g:vim_bootstrap_langs = "javascript,python,typescript,html"
...
Plug 'daniel1404/image.vim' " My fork of image.vim. Preview images with nerdtree

Plug 'mhinz/vim-startify' " Startify screen
...
" FOR RESIZE WINDOWS
nnoremap <leader><leader> :winc =<CR>
nnoremap H :winc <<CR>
nnoremap L :winc ><CR>
" For manage tabs
...
" CUSTOM VIM BINDINGS
""""""""""""""
" Leader + s for call apps
nnoremap <leader>zs :Startify<CR>

" terminal emulation
nnoremap <leader>zt :terminal<CR>
...
nnoremap <leader>r :call Save_and_format_python()<CR>
